		...
		<Modal v-model="modal14" :loading="modal14loading" scrollable :title="title" @on-ok="addok">
			<Form ref="formValidate" :model="admin" :label-width="80">
				...
				<FormItem label="密码" prop="aPassword">
					...
					<Input v-model="admin.aName" :maxlength=20 placeholder="请输入账号"></Input>
				</FormItem>
				</FormItem>
				<FormItem label="权限" prop="aRank">
					<Input v-model="admin.aRank" placeholder="1:管理员/0:网点管理员"></Input>
				</FormItem>
				<FormItem label="性别" prop="aSex">
				<Select v-model="admin.aType" style="width: 150px;">
