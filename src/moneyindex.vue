		...
		<Layout>
			...
			<Layout>
					...
					<Menu @on-open-change="fu" @on-select="ze" :accordion="true" active-name="1-2" :theme="theme" width="auto"
					 :open-names="['1']">
						...
						<Submenu name="数据报表">
							...
							<router-Link to="/moneyindex/sjcztj">
						...
						<Submenu name="财务管理">
							...
							<router-Link to="/moneyindex/reportSelect">
								<MenuItem name="财务报表">财务报表</MenuItem>
							</router-Link>
						</Submenu>
						...
						<Submenu name="业务员管理">
							...
							<router-Link to="/moneyindex/staffSelect">
								<MenuItem name="业务员管理">业务员管理</MenuItem>
							</router-Link>
						</Submenu>
              ...
              <Submenu name="网点管理">
							...
							<router-Link to="/moneyindex/networkSelect">
								<MenuItem name="网点管理">网点管理</MenuItem>
							</router-Link>
						</Submenu>
            ...
            <Submenu name="客户管理">
							...
							<router-Link to="/moneyindex/customerSelect">
								<MenuItem name="客户信息">客户信息</MenuItem>
							</router-Link>
						</Submenu>
			...
			ok() {
				...
				axios.get(th.url + '/admin/updatePassword', {
					...
					if (res.data.code == 200) {
						...
						setTimeout(function() {
							window.location.href = "/moneyindex";
						}, 500);
					} else {
