<template>
	<div>
		<Row>
			...
			<div style="background-color: #6699ff;height: 120px;margin: 30px;border-radius: 5%; ">
				<Icon type="md-medal" size="100" />
				<div style="background-color: #e4ebfd;height: 25px;">
...
<script>
	export default {
		...
		created() {
const th = this;
			axios.get(th.url + '/waybill/getCount', {
						params: {
